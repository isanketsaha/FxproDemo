...
@Slf4j
public class HourSizeConfig extends SimpleCompletionPolicy implements ItemReader<Quote> {
        ...
        public boolean isComplete() {
            ...
            try {
                ...
                if (currentReadItem != null && nextReadItem != null) {
                    ...
                    if (AppUtils.isSameHour(currentReadItem.getUtcTimestamp(), nextReadItem.getUtcTimestamp())) {
